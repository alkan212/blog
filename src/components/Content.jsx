...
import { Testimonials } from '@/components/tailwind/Testimonials'
    ...
    <div className="relative overflow-hidden bg-white py-16">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-prose text-lg flex flex-col items-center">
          ...
          <Sujet className={color}>Crypto</Sujet>
          <Titre>Top 10 Crypto to buy now</Titre>
        
          <Introduction>Aliquet nec orci mattis amet quisque ullamcorper neque, nibh sem. At arcu, sit dui mi, nibh dui, diam eget aliquam. Quisque id at vitae feugiat egestas ac. Diam nulla orci at in viverra scelerisque eget. Eleifend egestas fringilla sapien.</Introduction>
        </div>
